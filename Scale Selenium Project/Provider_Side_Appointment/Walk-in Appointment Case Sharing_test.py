...
def test_create_patient(login):
    ...
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "//button[contains(text(),'+ Create Case')]"))
    ).click()
    ...
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "//button[contains(text(),'History')][1]"))
    ).click()
    ...
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "//button[contains(text(),'Medication')]"))
    ).click()
    ...
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "//button[contains(text(),'Vital Signs')]"))
    ).click()
    ...
    time.sleep(3)
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "//button[contains(text(),'Immunization History')][1]"))
    ).click()
    ...
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "//button[contains(text(),'Observations')]"))
    ).click()
    ...
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "//button[contains(text(),'Diagnosis')]"))
    ).click()
    ...
    # WebDriverWait(login, 10).until(
    #     EC.presence_of_element_located((By.XPATH, "//button[contains(text(),'Treatment Plan')]"))
    # ).click()

    # login.find_element(By.XPATH, "//span[@class='ng-tns-c261-80 p-autocomplete p-component']//input[@type='text']").send_keys("Treatment 1")
    WebDriverWait(login, 10).until(
