...
def test_IP_workflow_New_IP_Patient(login):
    ...
    try:
        ...
        time.sleep(1)
        wait_and_locate_click(login, By.XPATH, "(//p-dropdown[@id='selectBedPrice_IP_BedCrt'])[1]")
        ...
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "//button[@id='btnAddService_IP_VL_VL']")

        time.sleep(2)
        wait.until(
            EC.presence_of_element_located(
                (By.XPATH, "//input[@placeholder='Search Service']"))
        ).send_keys("Doc")
        ...
        time.sleep(2)
        wait_and_click(login, By.XPATH, "(//span[@class='p-dropdown-trigger-icon pi pi-clock ng-star-inserted'])[1]")
        ...
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "(//div[contains(text(),'Discharge')])[1]")
...
def test_IP_workflow_Reservations(login):
    ...
    try:
        ...
        wait_and_locate_click(login, By.XPATH, "//button[@id='btnAdmit_IP_RG_LI']")

        time.sleep(2)
        admit_button = wait.until(
            EC.presence_of_element_located((By.XPATH, "//button[@id='btnAssignAdmit_IP_NA_NA']"))
        )
        ...
        time.sleep(2)
        wait_and_click(login, By.XPATH, "(//li[@role='option' and contains(@class,'p-dropdown-item')])[1]")
        time.sleep(1)
        # # Locate the minute up arrow
        # minute_up_button = login.find_element(By.XPATH, "//div[contains(@class,'p-minute-picker')]//button[1]")
        ...
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "(//button[normalize-space()='Use Template'])[2]")
...
def test_IP_workflow_Patient_to_IP_Patient(login):
    ...
    try: 
        ...
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "(//img[@src='assets/images/add-cust.svg'])[1]")

        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "(//img[@alt='add Patient'])[1]")
        ...
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "(//img)[19]")

        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "(//span[normalize-space()='Create IP Admission'])[1]")
