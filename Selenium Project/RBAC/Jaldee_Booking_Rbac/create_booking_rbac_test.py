...
@allure.severity(allure.severity_level.CRITICAL)
@allure.title("RBAC Booking Management with disabling Rescheduling")
@pytest.mark.parametrize("url", ["https://scale.jaldee.com/business/"])
def test_Rbac_Disabled_reschedule(login):
     try:
          wait_and_locate_click(login, By.XPATH, "//div[contains(text(),'Settings')]")
          time.sleep(2)
          rbac = WebDriverWait(login, 10).until(
          ...
          time.sleep(2)
          checkbox = WebDriverWait(login, 10).until(
               EC.presence_of_element_located((By.XPATH, "(//input[@id='mat-mdc-checkbox-6-input'])[1]"))
               )
          is_checked = checkbox.is_selected()
          if is_checked:
               print("Checkbox is selected, proceeding to disabled the Rescheduling...")
               rescheduling = WebDriverWait(login, 10).until(
                    EC.presence_of_element_located((By.XPATH, "(//div[@class='mdc-form-field'])[6]"))
               )
               rescheduling.click()
               time.sleep(2)
               wait_and_locate_click(login, By.XPATH, "//button[normalize-space()='Save']")
          ...
          time.sleep(2)
          reschedule = WebDriverWait(login, 10).until(
               EC.invisibility_of_element_located((By.XPATH, "//button[normalize-space()='Reschedule']"))
          )
          if not reschedule:
               print("Testcase Failed: Reschedule button is visible after disabling checkbox.")
               assert False, "Reschedule button is visible after disabling checkbox.!"
          else:
               print("Test passed: Reschedule button is NOT visible after disabling checkbox.")
          time.sleep(3)
     except Exception as e:
          allure.attach(  
          login.get_screenshot_as_png(),  
...
@allure.severity(allure.severity_level.CRITICAL)
@allure.title("RBAC Booking Management with enabling Rescheduling")
@pytest.mark.parametrize("url", ["https://scale.jaldee.com/business/"])

def test_Rbac_Enabled_rescheduling(login):
     try:
          wait_and_locate_click(login, By.XPATH, "//div[contains(text(),'Settings')]")
          time.sleep(2)
          rbac = WebDriverWait(login, 10).until(
          ...
          time.sleep(2)
          reschedule = WebDriverWait(login, 10).until(
               EC.presence_of_element_located((By.XPATH, "//button[normalize-space()='Reschedule']"))
          )
          assert reschedule.is_displayed(), "Reschedule button is NOT displayed after enabling checkbox!"
          print("Reschedule button is displayed. Proceeding to reschedule booking.")
          reschedule.click()
          time.sleep(2)
     except Exception as e:
          allure.attach(  
...
@allure.severity(allure.severity_level.CRITICAL)
@allure.title("RBAC Booking Management with disabling Followup")
@pytest.mark.parametrize("url", ["https://scale.jaldee.com/business/"])
def test_Rbac_Disabled_followup(login):
     try:
          wait_and_locate_click(login, By.XPATH, "//div[contains(text(),'Settings')]")
          time.sleep(2)
          rbac = WebDriverWait(login, 10).until(
          ...
          time.sleep(2)
          checkbox = WebDriverWait(login, 10).until(
               EC.presence_of_element_located((By.XPATH, "(//input[@id='mat-mdc-checkbox-7-input'])[1]"))
               )
          is_checked = checkbox.is_selected()
          if is_checked:
               print("Checkbox is selected, proceeding to disabled the Followup...")
               followup = WebDriverWait(login, 10).until(
                    EC.presence_of_element_located((By.XPATH, "(//div[@class='mdc-form-field'])[7]"))
               )
               followup.click()
               time.sleep(2)
               wait_and_locate_click(login, By.XPATH, "//button[normalize-space()='Save']")
          ...
          time.sleep(2)
          Followup = WebDriverWait(login, 10).until(
               EC.invisibility_of_element_located((By.XPATH, "//button[normalize-space()='Follow Up']"))
          )
          if not Followup:
               print("Testcase Failed: Followup button is visible after disabling checkbox.")
               assert False, "Followup button is visible after disabling checkbox.!"
          else:
               print("Test passed: Followup button is NOT visible after disabling checkbox.")
          time.sleep(3)
     except Exception as e:
          allure.attach(  
          login.get_screenshot_as_png(),  
...
def test_Rbac_Enabled_followup(login):
     try:
          wait_and_locate_click(login, By.XPATH, "//div[contains(text(),'Settings')]")
          time.sleep(2)
          rbac = WebDriverWait(login, 10).until(
          ...
          assert Followup.is_displayed(), "Followup button is NOT displayed after enabling checkbox!"
          print("Followup button is displayed. Proceeding to reschedule booking.")
          Followup.click()
          time.sleep(2)
     except Exception as e:
          allure.attach(  
