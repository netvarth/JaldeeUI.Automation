...
@pytest.mark.parametrize("url", ["https://scale.jaldee.com/business/"])
def test_followup_patient_sameday(login):
    time.sleep(5)
    WebDriverWait(login, 20).until(
        EC.presence_of_element_located(
            (
...
@pytest.mark.parametrize("url", ["https://scale.jaldee.com/business/"])
def test_followup_patient_futuredays(login):
    time.sleep(5)
    WebDriverWait(login, 20).until(
        EC.presence_of_element_located(
            (
...
@pytest.mark.parametrize("url", ["https://scale.jaldee.com/business/"])
def test_followup_create_patient_futuredays(login):
    time.sleep(5)
    WebDriverWait(login, 20).until(
        EC.presence_of_element_located(
            (
...
def test_user_followup(login):
    ...
    lucenesearch.send_keys("9400553615")
    time.sleep(5)
    WebDriverWait(login, 10).until(
    ...
    droplocation.click()
    print("Select Location:", droplocation.text)
    userelement_dropdown = WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "(//div[@class='p-inputgroup'])[2]"))
    )
    userelement_dropdown.click()
    time.sleep(3)
    select_user = WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "//span[@class='ng-star-inserted'][normalize-space()='Laxmy R']"))
    )
    select_user.click()
    print("Select User:", select_user.text)
    select_service = WebDriverWait(login, 10).until(
        EC.presence_of_element_located(
            (By.XPATH, "//p-dropdown[@optionlabel='name']//div[@class='text-left p-dropdown p-component']"))
    )
    print("Select service:",select_service.text)
    time.sleep(3)
    ...
    time.sleep(5)
    print("ViewDetails Button Clicked") 
     # # **** User Followup on the first day of the upcoming month*****
    WebDriverWait(login, 10).until(
    ...
    calendar_firstday_select.click()
    print("User follow up on the first day of the upcoming month:",calendar_firstday_select)
    time.sleep(2)
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "//span[normalize-space()='Confirm']"))
    ).click()
...
@pytest.mark.parametrize("url", ["https://scale.jaldee.com/business/"])
def test_user_followup_futuredays(login):
    time.sleep(5)
    WebDriverWait(login, 20).until(
        EC.presence_of_element_located((By.XPATH, "//img[contains(@src, 'tokens.gif')]//following::div[@class='my-1 font-small ng-star-inserted']//span[normalize-space(text())='Tokens']"))
    ).click()
