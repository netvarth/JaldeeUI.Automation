...
def test_create_patient(login):
    ...
    try:
        ...
        login.find_element(By.XPATH, "(//textarea[@id='tctareaMsg_BUS_addNote'])[1]").send_keys(
...
@allure.severity(allure.severity_level.CRITICAL)
@allure.title("Post deployment create prescription and sharing")
@pytest.mark.parametrize("url, username, password", [(prod_url, main_prod, password)])
def test_create_prescription(login):
    ...
    try:
        ...
        #  ***************** Case Creation from patient record ****************

@allure.severity(allure.severity_level.CRITICAL)
@allure.title("Post deployment create case and sharing")
@pytest.mark.parametrize("url, username, password", [(prod_url, main_prod, password)])
def test_create_case(login):
    ...
    try:
        ...
        ).send_keys("Case created from  patient record tab")
        ...
        print("Case share successfully")

        #  ***************** Case Creation from appointment details ****************
        ...
        ).send_keys("Case created from appointment details page")
        ...
        print("Case shared successfully")
...
@allure.severity(allure.severity_level.CRITICAL)
@allure.title("Post deployment rescheduling of appointment")
@pytest.mark.parametrize("url, username, password", [(prod_url, main_prod, password)])
def test_reschedule_appointment(login):
...
@allure.severity(allure.severity_level.CRITICAL)
@allure.title("Post deployment cancellation of appointment")
@pytest.mark.parametrize("url, username, password", [(prod_url, main_prod, password)])
def test_cancel_appointment(login):
