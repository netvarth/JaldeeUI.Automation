...
def test_account_signup():
    ...
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located(
            (By.XPATH, "(//span[@class='lnk setings ml-auto'])[6]")
        )
    ).click()
    time.sleep(2)
    WebDriverWait(login, 10).until(
    ...
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located(
            (By.XPATH, "//p[contains(text(),'Set when you want to start a virtual queue and iss')]")
        )
    ).click()

    time.sleep(2)
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "//span[normalize-space()='Add Queue']"))
    ).click()
    ...
    title = WebDriverWait(login, 10).until(
        EC.presence_of_element_located(
            (
                By.XPATH,
                "//label[normalize-space()='Title for Queue * (not visible to public)']",
            )
        )
    )
    ...
    title_input.send_keys("Test Queue")
    ...
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located(
            (
                By.XPATH,
                "//body[1]/app-root[1]/app-business[1]/div[1]/div[1]/div[1]/app-provider-settings[1]/section[1]/app-old-settings[1]/section[1]/div[1]/div[1]/div[2]/div[1]/div[2]/ul[1]/li[1]/a[1]/p[1]",
            )
        )
    ).click()
