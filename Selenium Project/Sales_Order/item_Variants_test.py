...
def test_Orders_Itemvariants(login):
    try:
        time.sleep(5)
        wait_and_locate_click(login, By.XPATH, "(//img)[2]") 
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "//div[contains(text(),'Item Variants')]") 
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "(//div[@id='actionSltOpt_ORD_ItemVar'])[1]") 
        time.sleep(2)
        ...
        wait_and_locate_click(login, By.XPATH, "//div[contains(text(),'Item Variants')]") 
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "(//div[@id='actionSltOpt_ORD_ItemVar'])[2]") 
        time.sleep(2)
        ...
        wait_and_locate_click(login, By.XPATH, "//div[contains(text(),'Item Variants')]") 
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "(//div[@id='actionSltOpt_ORD_ItemVar'])[4]") 
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "//span[normalize-space()='Create']") 
        time.sleep(2)
        ...
        wait_and_locate_click(login, By.XPATH, "//div[contains(text(),'Item Variants')]") 
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "(//div[@id='actionSltOpt_ORD_ItemVar'])[5]") 
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "//span[normalize-space()='Create']") 
        time.sleep(2)
        ...
        wait_and_locate_click(login, By.XPATH, "//div[contains(text(),'Item Variants')]") 
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "(//div[@id='actionSltOpt_ORD_ItemVar'])[6]") 
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "//span[normalize-space()='Create']") 
        time.sleep(2)
        ...
        wait_and_send_keys(login, By.XPATH, "//input[@id='inputHsn_ORD_ItemCrtPop']", unit_name)
        time.sleep(2)
        quantity = random.randint(1, 100)
        wait_and_send_keys(login, By.XPATH, "//input[@id='inputQty_ORD_ItemCrtPop']", quantity)
        time.sleep(2)
        ...
        wait_and_locate_click(login, By.XPATH, "//div[contains(text(),'Item Variants')]") 
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "//input[@id='inputHsn_ORD_ItemCrtPop']") 
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "//span[normalize-space()='Create']") 
        time.sleep(2)
        ...
        wait_and_send_keys(login, By.XPATH, "//input[@id='inputHsn_ORD_ItemCrtPop']", HSN_code)
        time.sleep(2)
        ...
        wait_and_send_keys(login, By.XPATH, "//input[@id='inputHsn_ORD_ItemCrtPop']", Remark_name)
        time.sleep(2)
