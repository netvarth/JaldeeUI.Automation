...
@allure.severity(allure.severity_level.CRITICAL)
@allure.title("New MR share with only case")
@pytest.mark.parametrize("url, username, password", [(scale_url, main_scale, password)])
def test_withonly_case_New_MR(login):
    try:
        driver = login
        wait= WebDriverWait(login, 30)
        time.sleep(5)
...
@allure.severity(allure.severity_level.CRITICAL)
@allure.title("New MR share with only prescription")
@pytest.mark.parametrize("url, username, password", [(scale_url, main_scale, password)])
...
@allure.severity(allure.severity_level.CRITICAL)
@allure.title("New MR share with uploaded prescription")
@pytest.mark.parametrize("url, username, password", [(scale_url, main_scale, password)])
...
@allure.severity(allure.severity_level.CRITICAL)
@allure.title("New MR Sharing with case and prescription")
@pytest.mark.parametrize("url, username, password", [(scale_url, main_scale, password)])
def test_with_caseandprescriptions_NewMR(login):
    try:
