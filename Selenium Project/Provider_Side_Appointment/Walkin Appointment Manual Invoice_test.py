...
def test_appt_manualinvoice2(login):
    ...
    time.sleep(2)
    WebDriverWait(login, 10).until(
        EC.element_to_be_clickable((By.XPATH, "//button[normalize-space()='Add Procedure/Item']"))
    ).click()
    ...
    WebDriverWait(login, 10).until(
        EC.presence_of_element_located((By.XPATH, "//div[@class='item-name'][normalize-space()='Consultation']"))
    ).click()
