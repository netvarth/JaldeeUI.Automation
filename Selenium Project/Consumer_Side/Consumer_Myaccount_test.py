...
def test_signup_myaccount(login):
    try:
        ...
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "//button[@type='button']")
        time.sleep(2)
        ...
        print(month_xpath)
        wait_and_locate_click(login, By.XPATH, month_xpath)
        time.sleep(2)
        ...
        print(day_xpath)
        wait_and_locate_click(login, By.XPATH, day_xpath)
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "//input[@placeholder='DD/MM/YYYY']")
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "//div[@aria-label='dropdown trigger']")
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "//li[@aria-label='female']")
        time.sleep(2)
        ...
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "//span[@class='deleteac']")
        time.sleep(2)
...
def test_signup_myaccount_familymember(login):
    try:
        consumer_data = create_consumer_data()
        time.sleep(5)
        wait_and_locate_click(login, By.XPATH, "//a[normalize-space()='My Bookings']")
        ...
        time.sleep(3)
        consumer_data = create_consumer_data()
        wait_and_locate_click(login, By.XPATH, "//span[normalize-space()='Family Members']")
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "//span[@class='btnTextCust']")
        time.sleep(3)
        selectbtn = WebDriverWait(login, 10).until(
        ...
        wait_and_locate_click(login, By.XPATH, salutation_option_xpath, 15)
        time.sleep(5)
        wait_and_send_keys(login, By.XPATH, "(//input[@id='first_name'])[2]", consumer_data['first_name'])
        print("Familymemeber Firstname:", consumer_data['first_name'])
        wait_and_send_keys(login, By.XPATH, "(//input[@id='last_name'])[2]", consumer_data['last_name'])
        ...
        # wait_and_locate_click(login, By.XPATH, "//input[@placeholder='DD/MM/YYYY']")
        # time.sleep(3)
        # wait_and_locate_click(login, By.XPATH, "//span[@aria-label='Gender']")
        # time.sleep(2)
        # wait_and_locate_click(login, By.XPATH, "//li[@aria-label='female']")
        # time.sleep(2)
        wait_and_send_keys(login, By.XPATH, "(//input[@id='phone'])[1]", consumer_data['phonenumber'])
        ...
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "(//span[@class='ng-star-inserted'][normalize-space()='Save'])[2]")
        message = get_snack_bar_message(login)
        print("Snack bar message:", message)
        time.sleep(3)
        wait_and_locate_click(login, By.XPATH, "//i[@class='fa fa-window-close hoverCross']")
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "//div[@class='btnClrTextRemove ng-star-inserted']")
        time.sleep(2)
        wait_and_locate_click(login, By.XPATH, "//button[normalize-space()='Confirm']")
        time.sleep(2)
    except Exception as e:
        allure.attach(  
            login.get_screenshot_as_png(),  
